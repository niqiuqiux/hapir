import { getPermissionModeLabel, getPermissionModeTone, isPermissionModeAllowedForFlavor } from '@/lib/protocol'
import type { PermissionModeTone } from '@/lib/protocol'
