...
export type SyncEvent = { "type": "session-added", sessionId: string, namespace: string | null, data: JsonValue | null, } | { "type": "session-updated", sessionId: string, namespace: string | null, data: JsonValue | null, } | { "type": "session-removed", sessionId: string, namespace: string | null, } | { "type": "message-received", sessionId: string, namespace: string | null, message: DecryptedMessage, } | { "type": "machine-updated", machineId: string, namespace: string | null, data: JsonValue | null, } | { "type": "toast", namespace: string | null, data: ToastData, } | { "type": "connection-changed", namespace: string | null, data: ConnectionChangedData | null, };
