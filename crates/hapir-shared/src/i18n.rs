    ...
    if is_zh() {
        (
            ...
            vec![
                ...
                SubAbout {
                    name: "gemini",
                    about: "启动 Gemini 代理会话",
                    children: vec![],
                },
                SubAbout {
                    name: "opencode",
                    about: "启动 OpenCode 代理会话",
                    children: vec![],
                },
                SubAbout {
                    name: "mcp",
                    about: "运行 MCP stdio 桥接",
                    children: vec![],
                },
                SubAbout {
                    name: "hook-forwarder",
                    about: "内部：转发 hook 事件到 runner",
                    children: vec![],
                },
                SubAbout {
                    name: "hub",
        ...
        (
            ...
            vec![
                SubAbout {
                    name: "claude",
                    about: "Start a Claude agent session (default)",
                    children: vec![],
                },
                SubAbout {
                    name: "codex",
                    about: "Start a Codex agent session",
                    children: vec![],
                },
                SubAbout {
                    name: "gemini",
                    about: "Start a Gemini agent session",
                    children: vec![],
                },
                SubAbout {
                    name: "opencode",
                    about: "Start an OpenCode agent session",
                    children: vec![],
                },
                SubAbout {
                    name: "mcp",
                    about: "Run the MCP stdio bridge",
                    children: vec![],
                },
                SubAbout {
                    name: "hook-forwarder",
                    about: "Internal: forward hook events to the runner",
                    children: vec![],
                },
                SubAbout {
                    name: "hub",
                ...
                SubAbout {
                    name: "runner",
                    about: "Runner process management",
                    children: vec![
                ...
                SubAbout {
                    name: "doctor",
                    about: "Show diagnostics information",
                    children: vec![],
                },
            ],
        )
